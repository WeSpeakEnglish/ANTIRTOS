...
```cpp
 ...
 in some timer or periodic function:
  ...
  you may utilize your desired timer variable type using following templated classes. Default type of timer variable is *unsigned long*. 
...
### Tips
- [X] It is recommended to use queues with lengts of pow 2 (ex 4, 8, 16, 32, 64 or 128) as compiler will simplify the % operations.
